      ...
      <div className="hidden w-1/2 bg-gradient-to-br from-[#6B46C1] via-[#3182CE] to-[#38B2AC] lg:block">
        <div className="flex h-full flex-col items-center justify-center p-8">
          <div className="relative mb-8 h-20 w-20">
            <Image src="/logo.png" alt="Pulse" fill className="object-contain" />
          </div>
          <h1 className="mb-6 text-center text-4xl font-bold text-white">
            <span className="text-[#F6AD55]">PULSE</span> <span className="text-white">Logs</span>
          </h1>
      ...
      <div className="flex w-full flex-col items-center justify-center p-4 lg:w-1/2 lg:p-8">
        <div className="mb-8 flex items-center lg:hidden">
          ...
          <h1 className="text-2xl font-bold">
            <span className="text-[#F6AD55]">PULSE</span> <span className="text-[#2C5282]">Logs</span>
          </h1>
        </div>
